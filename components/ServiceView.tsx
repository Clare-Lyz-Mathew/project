...
const ServiceView: React.FC<ServiceViewProps> = ({ service, onClose, onBook }) => {
  return (
    <div className="fixed inset-0 z-[60] bg-charcoal overflow-y-auto animate-fade-in">
            ...
            <div className="mb-16">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-y-4">
                {service.features.map((feature, idx) => (
                  <li key={idx} className="flex items-center gap-4 text-silver">
