  ...
  return (
    <div className="min-h-screen bg-seashell">
      ...
      <main className="pt-24">
        {/* Hero Section */}
        <section className="bg-space-indigo text-white py-24">
          <div className="container mx-auto px-6">
            ...
            <h1 className="text-5xl md:text-7xl font-serif mb-6">About Elyza Events</h1>
            <p className="text-seashell/90 text-xl max-w-3xl leading-relaxed">
        ...
        <section className="py-24">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <div className="h-1 w-24 bg-almond-silk mb-8" />
              <p className="text-dusty-grape text-lg leading-relaxed mb-6">
              ...
              <p className="text-space-indigo text-xl font-serif italic">
        ...
        <section className="py-24 bg-lilac-ash/10">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-4xl md:text-5xl font-serif text-space-indigo mb-8">Our Mission</h2>
              <p className="text-dusty-grape text-lg leading-relaxed mb-12">
                To create events that transcend the ordinary—whether celebrating life's milestones or honoring its 
                passages. We approach each event with the understanding that behind every celebration or memorial 
                is a unique narrative deserving of thoughtful, respectful, and beautiful expression.
              </p>
              
              <h2 className="text-4xl md:text-5xl font-serif text-space-indigo mb-8">Our Philosophy</h2>
        ...
        <section className="py-24">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-serif text-space-indigo mb-4">Our Values</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
              {values.map((value, index) => {
                ...
                return (
                  <div key={index} className="bg-seashell border border-almond-silk/20 rounded-soft p-8 shadow-soft">
                    ...
                    <h3 className="text-2xl font-serif text-space-indigo mb-4">{value.title}</h3>
                    <p className="text-dusty-grape leading-relaxed">{value.description}</p>
                  </div>
                );
              })}
            </div>
        ...
        <section className="py-24 bg-space-indigo text-white">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-4xl md:text-5xl font-serif mb-8">Our Team</h2>
              <p className="text-seashell/90 text-lg leading-relaxed mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-dusty-grape/20 rounded-soft p-6">
                  <div className="w-24 h-24 bg-almond-silk/20 rounded-full mx-auto mb-4" />
                  <h3 className="font-serif text-xl mb-2">Event Coordinators</h3>
                  <p className="text-seashell/80 text-sm">Expert planning and execution</p>
                </div>
                <div className="bg-dusty-grape/20 rounded-soft p-6">
                  <div className="w-24 h-24 bg-almond-silk/20 rounded-full mx-auto mb-4" />
                  <h3 className="font-serif text-xl mb-2">Design Specialists</h3>
                  <p className="text-seashell/80 text-sm">Creative vision and styling</p>
                </div>
                <div className="bg-dusty-grape/20 rounded-soft p-6">
                  <div className="w-24 h-24 bg-almond-silk/20 rounded-full mx-auto mb-4" />
                  <h3 className="font-serif text-xl mb-2">Cultural Consultants</h3>
                  <p className="text-seashell/80 text-sm">Authentic tradition guidance</p>
                </div>
              </div>
            </div>
          </div>
