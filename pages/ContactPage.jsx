  ...
  return <div className="min-h-screen">
    ...
    /* Header Section */
        ...
        <section className="relative py-16 overflow-hidden border-b border-navy/10">
          <div className="absolute inset-0 z-0 bg-cover bg-center" style={{ backgroundImage: `url('/gallery/corporate_gala.png')` }}>
            ...
            <div className="lg:col-span-1">
              <div className="bg-mist border border-mauve/20 rounded-soft p-8 shadow-soft sticky top-32">
                ...
                <div className="space-y-6 mb-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:concierge@elyzaevents.com" className="text-navy hover:text-mauve transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+914842350123" className="text-navy hover:text-mauve transition-colors">
                        +91 484 235 0123
                      </a>
                    </div>
                  </div>
                ...
                <div className="border-t border-mauve/20 pt-6">
                  ...
                  <a href="tel:+914842350124" className="text-mauve font-semibold hover:text-navy transition-colors">
                    Emergency: +91 484 235 0124
                  </a>
                </div>
              </div>
            </div>
