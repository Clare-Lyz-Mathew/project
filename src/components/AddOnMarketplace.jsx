...
const AddOnMarketplace = ({ selectedAddOns, onToggleAddOn }) => {
  const categories = ["Catering", "Light & Sound", "Photo/Video", "Decor"];
  return <div className="py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        {categories.map((cat) => <div key={cat} className="mb-20 last:mb-0">
    ...
    >
                    ...
                    <div className="p-6">
                      ...
                      <ul className="mb-8 space-y-2">
                        {item.specs?.map((spec, i) => <li key={i} className="text-[10px] tracking-widest text-slate font-semibold uppercase flex items-center gap-2">
      ...
      className={`w-full py-3 text-xs tracking-[0.2em] font-bold transition-all duration-500 flex items-center justify-center gap-2 ${isSelected ? "bg-charcoal text-white" : "border border-charcoal text-charcoal hover:bg-charcoal hover:text-white"}`}
    >
