  ...
  const services = [
    {
      ...
      icon: Utensils,
      images: [
        "/gallery/contact_hero_corporate.png"
      ]
    },
    {
      id: "decor-1",
      ...
      icon: Palette,
      images: [
        "/gallery/anniversary_background.png"
      ]
    },
    {
      id: "photography-1",
    ...
    },
    {
      ...
      icon: Building2,
      images: [
        "/gallery/hero_reunion_dinner.jpg",
        "/gallery/catering_custom_table.jpg"
      ]
    }
  ];
  ...
  return <div className="min-h-screen">
    ...
    /* Header Section */
        ...
        <section className="relative py-16 overflow-hidden border-b border-navy/10">
          <div className="absolute inset-0 z-0 bg-cover bg-center" style={{ backgroundImage: `url('/gallery/birthday_addon_hero.png')` }}>
