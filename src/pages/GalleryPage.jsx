...
const GalleryPage = () => {
  ...
  const galleryItems = [
    { id: "1", image: "/gallery/hero_reunion_dinner.jpg", category: "Wedding", caption: "Elegant Evening Gala Reception", tags: ["Elegant", "Gala", "Reception"] },
    { id: "2", image: "/gallery/wedding_customization_hero.png", category: "Wedding", caption: "Elegant Christian Wedding in a Grand Church", tags: ["Elegant", "Christian", "Altar"] },
    { id: "3", image: "/gallery/catering_custom_table.jpg", category: "Catering", caption: "Luxurious Fine Dining Table Setup", tags: ["Fine Dining", "Gourmet", "Bespoke"] },
    { id: "4", image: "/gallery/contact_hero_corporate.png", category: "Custom", caption: "Grand Ballroom Corporate Gala", tags: ["Corporate", "Luxury", "Gala"] },
    { id: "5", image: "/gallery/birthday_addon_hero.png", category: "Birthday", caption: "Lively Luxury Birthday Celebration", tags: ["Lively", "Modern", "Balloons"] },
    { id: "6", image: "/gallery/memorial_service_gallery.png", category: "Memorial", caption: "Peaceful and Dignified Memorial Service", tags: ["Peaceful", "Respectful", "White Wreaths"] },
    { id: "7", image: "/gallery/anniversary_background.png", category: "Anniversary", caption: "Golden Anniversary Champagne Toast", tags: ["Toast", "Golden", "Crystal"] },
    { id: "8", image: "/gallery/home_hero_baptism.png", category: "Baptism", caption: "Serene Baptism Ceremony Setup", tags: ["Serene", "Holy", "Candles"] },
    { id: "9", image: "/gallery/religious_baptism_decor.jpg", category: "Baptism", caption: "Elegant Balloon Arch Christening Décor", tags: ["Balloons", "Elegant", "Christening"] },
    { id: "10", image: "/gallery/decor_balloon.jpg", category: "Birthday", caption: "Luxe Chrome Balloon Bouquet", tags: ["Balloons", "Gold", "Luxury"] },
    { id: "11", image: "/gallery/memorial_setup_category.jpg", category: "Memorial", caption: "Heartfelt Memorial Tribute Display", tags: ["Tribute", "Memorial", "Flowers"] },
    { id: "12", image: "/gallery/hero_reunion_dinner.jpg", category: "Reunion", caption: "Opulent Gala Reunion Dinner", tags: ["Opulent", "Candlelight", "Reunion"] },
    { id: "13", image: "/gallery/catering_custom_table.jpg", category: "Anniversary", caption: "Romantic Red Table Setting", tags: ["Romantic", "Crimson", "Anniversary"] }
  ];
  ...
  return <div className="min-h-screen">
    ...
    /* Header Section */
        ...
        <section className="relative py-16 overflow-hidden border-b border-navy/10">
          <div className="absolute inset-0 z-0 bg-cover bg-center" style={{ backgroundImage: `url('/gallery/wedding_customization_hero.png')` }}>
